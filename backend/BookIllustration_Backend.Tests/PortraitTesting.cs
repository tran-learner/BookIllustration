...
public class PortraitTesting
{
    ...
    public async Task RunPortraits_WithOwnedPendingStep_GeneratesMissingPortraits()
    {
        ...
        Assert.Equal(HttpStatusCode.Accepted, portraitResponse.StatusCode);

        await WaitForPortraitStepStatusAsync(
            factory,
    ...
    public async Task RunPortraits_WhileAnotherRequestIsRunning_ReturnsConflict()
    {
        ...
        var firstResponse = await client.PostAsync(portraitUrl, content: null);
    ...
    private static async Task WaitForPortraitStepStatusAsync(
        ...
        PipelineStepStatus expectedStatus)
    {
        ...
        throw new Xunit.Sdk.XunitException(
            $"The Portraits step did not reach {expectedStatus} within five seconds.");
    }
}
